<x-layout.hotelinfo>
    ...
    <style>
        ...
        .hotel-image-gallery img {
            ...
            /* Elke afbeelding neemt 50% breedte in */
            height: 100%;
            /* Volledige hoogte behouden */
            object-fit: cover;
            border-right: 1px solid #eee;
            /* Scheidingslijn tussen afbeeldingen */
        }

        .hotel-image-gallery img:last-child {
            border-right: none;
            /* Geen rand voor de laatste afbeelding */
        }
